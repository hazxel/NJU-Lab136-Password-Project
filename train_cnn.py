...
logger = logging.getLogger("train_cnn.py")
...
g = Generator_GRU(GEN_HIDDEN_SIZE, GEN_NEURON_SIZE, GEN_LAYERS).to(device)
d = Discriminator_CNN(CNN_NEURON_SIZE).to(device)
